...
- `card`: #FFFFFF
- `cardForeground`: hsla(240, 55%, 12%, 1)
- `color`: hsla(240, 55%, 12%, 1)
- `destructive`: #e5484d
- `destructiveForeground`: #641723
- `destructiveSoft`: #feebec
- `floatingSurface`: rgba(255, 255, 255, 0.94)
- `floatingSurfaceForeground`: hsla(240, 55%, 12%, 1)
- `foreground`: hsla(240, 55%, 12%, 1)
- `input`: hsla(238, 25%, 85%, 1)
- `muted`: hsla(236, 23%, 91%, 1)
- `mutedForeground`: hsla(240, 38%, 50%, 1)
- `primary`: #FF6B4A
- `primaryForeground`: hsla(240, 55%, 12%, 1)
- `primaryPressed`: #9F331F
- `ring`: hsla(42, 84%, 54%, 1)
- `secondary`: hsla(45, 50%, 88%, 1)
- `secondaryForeground`: hsla(38, 95%, 5%, 1)
- `success`: #30a46c
- `successSoft`: #e6f6eb
- `surface`: #FFFFFF
- `surfaceForeground`: hsla(240, 55%, 12%, 1)
- `transparent`: rgba(255, 255, 255, 0)
- `warning`: #ffe629
- `warningForeground`: #473b1f
- `warningSoft`: #fffab8
